...
replace github.com/vmware/cloud-provider-for-cloud-director => github.com/giantswarm/cloud-provider-for-cloud-director v0.0.0-20230130130729-9e1cd82916be
